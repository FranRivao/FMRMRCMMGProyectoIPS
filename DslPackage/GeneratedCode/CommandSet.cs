...
namespace UPM_IPS.FMRMRCMMGProyectoIPS
{
	...
	/// </summary>
	internal partial class FMRMRCMMGProyectoIPSCommandSet : FMRMRCMMGProyectoIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new FMRMRCMMGProyectoIPSCommandSet.
		/// </summary>
		public FMRMRCMMGProyectoIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class FMRMRCMMGProyectoIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new FMRMRCMMGProyectoIPSCommandSetBase.
		/// </summary>
		protected FMRMRCMMGProyectoIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewFMRMRCMMGProyectoIPSExplorerCommand,
				typeof(FMRMRCMMGProyectoIPSEditorFactory).GUID);
		...
		{
			FMRMRCMMGProyectoIPSExplorerToolWindow explorer = this.FMRMRCMMGProyectoIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected FMRMRCMMGProyectoIPSDocData CurrentFMRMRCMMGProyectoIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as FMRMRCMMGProyectoIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected FMRMRCMMGProyectoIPSDocView CurrentFMRMRCMMGProyectoIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as FMRMRCMMGProyectoIPSDocView;
			}
		}
		...
		/// </summary>
		protected FMRMRCMMGProyectoIPSExplorerToolWindow FMRMRCMMGProyectoIPSExplorerToolWindow
		{
			get
			{
				FMRMRCMMGProyectoIPSExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(FMRMRCMMGProyectoIPSExplorerToolWindow), true) as FMRMRCMMGProyectoIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				FMRMRCMMGProyectoIPSExplorerToolWindow explorerWindow = this.FMRMRCMMGProyectoIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class FMRMRCMMGProyectoIPSClipboardCommandSet : FMRMRCMMGProyectoIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new FMRMRCMMGProyectoIPSClipboardCommandSet.
		/// </summary>
		public FMRMRCMMGProyectoIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class FMRMRCMMGProyectoIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new FMRMRCMMGProyectoIPSClipboardCommandSetBase.
		/// </summary>
		protected FMRMRCMMGProyectoIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
