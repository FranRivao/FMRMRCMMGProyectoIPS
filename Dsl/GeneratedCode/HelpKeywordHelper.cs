...
namespace UPM_IPS.FMRMRCMMGProyectoIPS
{
	...
	/// </remarks>
	public partial class FMRMRCMMGProyectoIPSHelpKeywordHelper : FMRMRCMMGProyectoIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new FMRMRCMMGProyectoIPSHelpKeywordHelper.
		/// </summary>
		protected FMRMRCMMGProyectoIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the FMRMRCMMGProyectoIPSHelpKeywordHelper.
		/// </summary>
		public static FMRMRCMMGProyectoIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class FMRMRCMMGProyectoIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new FMRMRCMMGProyectoIPSHelpKeywordHelperBase.
		/// </summary>
		protected FMRMRCMMGProyectoIPSHelpKeywordHelperBase()
			: base() { }
