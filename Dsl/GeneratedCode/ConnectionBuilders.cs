...
namespace UPM_IPS.FMRMRCMMGProyectoIPS
{
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class EntidadReferencesRelacionBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
			...
			else // Check combinations
			{
				if (candidateSource is global::UPM_IPS.FMRMRCMMGProyectoIPS.Entidad)
				{
					if (candidateTarget is global::UPM_IPS.FMRMRCMMGProyectoIPS.Relacion)
					{
						...
						if(sourceEntidad == null || global::UPM_IPS.FMRMRCMMGProyectoIPS.EntidadReferencesRelacion.GetLinkToRelacion(sourceEntidad) != null) return false;
						if(targetRelacion == null || sourceEntidad == null || global::UPM_IPS.FMRMRCMMGProyectoIPS.EntidadReferencesRelacion.GetLinks(sourceEntidad, targetRelacion).Count > 0) return false;
						return true;
					}
				}
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::UPM_IPS.FMRMRCMMGProyectoIPS.Entidad)
				{
					if (target is global::UPM_IPS.FMRMRCMMGProyectoIPS.Relacion)
					{
						...
						DslModeling::ElementLink result = new global::UPM_IPS.FMRMRCMMGProyectoIPS.EntidadReferencesRelacion(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	/// Handles interaction between the ConnectionBuilder and the corresponding ConnectionTool.
	/// </summary>
	internal partial class EntidadRelacionConectorConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new EntidadRelacionConectorConnectAction for the given Diagram.
		/// </summary>
		public EntidadRelacionConectorConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the EntidadRelacionConectorConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			if(this.connectionTypes == null)
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new EntidadRelacionConectorConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class EntidadRelacionConectorConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the EntidadRelacionConectorConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected EntidadRelacionConectorConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder EntidadReferencesRelacionBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				bool canConnect = true;
				...
				{				
					if(targetShapeElement == null)
					{
						return EntidadReferencesRelacionBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return EntidadReferencesRelacionBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				DslModeling::ModelElement targetElement = targetShapeElement.ModelElement;
				if(targetElement == null) targetElement = targetShapeElement;
				EntidadReferencesRelacionBuilder.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class EntidadRelacionConectorConnectionType : EntidadRelacionConectorConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the EntidadRelacionConectorConnectionType with the given ConnectionBuilder.
			/// </summary>
			public EntidadRelacionConectorConnectionType() : base() {}
		}
	}
}
